...
const css$1 = {
  code: '.footer-background-svg{position:absolute;min-height:250px;height:100%;max-width:300px;width:auto;left:0;z-index:0}a.svelte-1blx8s9.svelte-1blx8s9,p.svelte-1blx8s9.svelte-1blx8s9{color:var(--text);font-family:var(--font-family, "Segoe UI");font-weight:300;font-size:0.93rem !important;line-height:1.6rem;color:white}a.svelte-1blx8s9.svelte-1blx8s9,ul.svelte-1blx8s9.svelte-1blx8s9,li.svelte-1blx8s9.svelte-1blx8s9{margin:0;padding:0}.flex.svelte-1blx8s9.svelte-1blx8s9{display:flex}.flex-wrap.svelte-1blx8s9.svelte-1blx8s9{flex-wrap:wrap;gap:20px}.flex-row.svelte-1blx8s9.svelte-1blx8s9{flex-direction:row}.space-between.svelte-1blx8s9.svelte-1blx8s9{justify-content:space-between}.footer-wrapper.svelte-1blx8s9.svelte-1blx8s9{position:relative}.justify-center.svelte-1blx8s9.svelte-1blx8s9{justify-content:center}.align-center.svelte-1blx8s9.svelte-1blx8s9{justify-content:center}.box.svelte-1blx8s9.svelte-1blx8s9{width:30%;min-width:200px;height:auto;width:auto;z-index:999}.large.svelte-1blx8s9.svelte-1blx8s9{height:100%;min-height:100%;align-self:start;align-items:start;justify-content:start;width:300px}footer.svelte-1blx8s9.svelte-1blx8s9{padding:20px 30px;min-height:300px;height:auto;width:100%;background-color:var(--primary)}footer.svelte-1blx8s9 .flex-wrapper.svelte-1blx8s9{width:100%}',
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<footer class="svelte-1blx8s9"><div class="flex flex-row footer-wrapper svelte-1blx8s9"><div class="logo large svelte-1blx8s9"><div class="svg-wrapper"><div style="display: contents; --leaves-main:#f0f0f01a; --leaves-overlay:#f0f0f01a; --tree-color:#f0f0f01a; --tree-overlay:#f0f0f01a; --svg-stroke-width:0px;">${validate_component(LogoSvg, "LogoSvg").$$render(
    $$result,
    {
    ...
    {}
        ...
        <div class="flex-wrapper flex flex-row flex-wrap space-between  svelte-1blx8s9"><div class="box contactd  svelte-1blx8s9"><h4>Kontakt</h4>
                <div class="adress-wrapper fex justify-center align-center svelte-1blx8s9"><p class="svelte-1blx8s9">Lisa-Marie Loof</p>
                    <p class="svelte-1blx8s9">Praxisstraße 33</p>
                    <p class="svelte-1blx8s9">9020 Klagenfurt</p>
                    <p class="svelte-1blx8s9">Austria</p></div>
                <div class="contact-wrapper fex justify-center align-center svelte-1blx8s9"><ul class="svelte-1blx8s9"><li class="svelte-1blx8s9"><a href="tel:+4369919048032" class="svelte-1blx8s9">Tel: 069919048032</a></li>
                        <li class="svelte-1blx8s9"><a href="mailto:praxis@lisaloof.at" class="svelte-1blx8s9">Mail: praxis@lisaloof.at</a></li></ul></div></div>
            <div class="box sitemap  svelte-1blx8s9"><h4>Links</h4>
                <div class="sitemap-wrapper fex justify-center align-center svelte-1blx8s9"><ul class="svelte-1blx8s9"><li class="svelte-1blx8s9"><a href="/" class="svelte-1blx8s9">Startseite</a></li>
                        <li class="svelte-1blx8s9"><a href="#" class="svelte-1blx8s9">Über mich</a></li>
                        <li class="svelte-1blx8s9"><a href="#" class="svelte-1blx8s9">Leistungen</a></li>
                        <li class="svelte-1blx8s9"><a href="#" class="svelte-1blx8s9">Kontakt</a></li></ul></div></div>
            <div class="box legal-notes svelte-1blx8s9"><h4>Rechtliches</h4>
                <div class="legal-notes-wrapper"><ul class="svelte-1blx8s9"><li class="svelte-1blx8s9"><a href="#" class="svelte-1blx8s9">Impressum</a></li>
                        <li class="svelte-1blx8s9"><a href="#" class="svelte-1blx8s9">Datenschutz</a></li></ul></div></div></div></div>
</footer>`;
});
const _layout_svelte_svelte_type_style_lang = "";
const css = {
  code: ".navigation{margin-top:5px}.logo{z-index:999;padding-top:10px}.hide.svelte-8qecy9.svelte-8qecy9{opacity:0;height:0;transition:all 0.2s ease-in-out}.scroll.svelte-8qecy9.svelte-8qecy9{box-shadow:rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.093) 0px 3px 7px -3px;opacity:1;transition:all 0.5s ease-in-out;transition:all 0.2s ease-in-out;background-color:#fff !important;height:85px !important}.content-wrapper.svelte-8qecy9.svelte-8qecy9{width:100vw;height:80px;display:flex;justify-content:center;align-items:center;background-color:#fff;z-index:999;position:fixed;top:0;transition:all 0.5s ease-in-out}.content-wrapper.svelte-8qecy9 header.svelte-8qecy9{position:absolute;display:flex;justify-content:center;align-items:center;top:0;z-index:999;width:100%;max-width:var(--content-width);justify-self:center;display:flex;flex-direction:row;justify-content:space-between;opacity:1;transition:all 0.5s ease-in-out}.app.svelte-8qecy9.svelte-8qecy9{width:100%;min-height:100vh;height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center}.app.svelte-8qecy9 main.svelte-8qecy9{min-height:100vh;height:100%;display:flex;flex-direction:column;justify-content:space-between;width:100%;margin-bottom:10rem}@media screen and (max-width: 680px){.app.svelte-8qecy9 #logoSvg{right:15px}}",
  map: null
};
...
<div class="app svelte-8qecy9"><div class="${[
    "content-wrapper svelte-8qecy9",
    (scrollY > offset && !hide ? "scroll" : "") + " " + (hide === true ? "hide" : "")
  ].join(" ").trim()}"><header class="svelte-8qecy9">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}
                ${validate_component(Navigation, "Navigation").$$render($$result, {}, {}, {})}</header></div>
        
        <main class="svelte-8qecy9">${slots.default ? slots.default({}) : ``}</main>
